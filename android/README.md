...
```gradle
dependencies {
    implementation 'com.github.apiverve:cardgenerator-api:1.1.14'
}
```
...
```java
import com.apiverve.cardgenerator.CardGeneratorAPIClient;
import com.apiverve.cardgenerator.APIResponse;
import com.apiverve.cardgenerator.APIException;

// Initialize the client
CardGeneratorAPIClient client = new CardGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("brand", "visa");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/cardgenerator](https://docs.apiverve.com/ref/cardgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/cardgenerator](https://docs.apiverve.com/ref/cardgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/cardgenerator-api/issues)
