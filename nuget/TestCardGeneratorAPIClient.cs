...
namespace APIVerve.API.TestCardGenerator
{
    ...
    /// <summary>
    /// Client for the TestCardGenerator API
    /// </summary>
    public class TestCardGeneratorAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        ...
        {
            { "brand", new ValidationRule { Type = "string", Required = true } },
            { "count", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 100 } },
            { "includeAvatar", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public TestCardGeneratorAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TestCardGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TestCardGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TestCardGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(TestCardGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(TestCardGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TestCardGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TestCardGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TestCardGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TestCardGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TestCardGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(TestCardGeneratorQueryOptions options)
        {
