...
namespace APIVerve\Cardgenerator;
...
/**
 * Client for the Test Card Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/cardgenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/cardgenerator';
    ...
    private const VALIDATION_RULES = [
        ...
        'includeAvatar' => ['type' => 'boolean', 'required' => false]
    ];
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CardgeneratorClient] {$message}\n";
        }
    }
}
