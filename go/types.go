// Package cardgenerator provides a Go client for the Card Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/cardgenerator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Card Generator API.
//
// Parameters:
//   - brand (required): string - The brand of the card to generate
//   - count: integer - The number of test card numbers to generate [min: 1, max: 100]
type Request struct {
...
// ResponseData contains the data returned by the Card Generator API.
...
type CardsItem struct {
	...
	Brand string `json:"brand"`
	NumberAlt NumberAltData `json:"number_alt"`
}

// NumberAltData represents the number_alt object.
type NumberAltData struct {
	Masked string `json:"masked"`
	Unmasked string `json:"unmasked"`
	Last4 string `json:"last4"`
}

// OwnerData represents the owner object.
type OwnerData struct {
	Name string `json:"name"`
	Address AddressData `json:"address"`
}

// AddressData represents the address object.
