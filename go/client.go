...
const (
	baseURL        = "https://api.apiverve.com/v1/cardgenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the Card Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Card Generator API client.
...
// Execute makes a request to the Card Generator API with typed parameters.
//
